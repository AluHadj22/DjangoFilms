    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.PositiveBigIntegerField(default=0, help_text='указать сумму в дролларах', verbose_name='Бюджет')),
                ('fies_in_usa', models.PositiveBigIntegerField(default=0, help_text='указать сумму в долларах', verbose_name='Сборы в США')),
                ('fies_in_world', models.PositiveBigIntegerField(default=0, help_text='указать сумму в долларах', verbose_name='Сборы в мире')),
                ('url', models.SlugField(max_length=160, unique=True)),
                ('draft', models.BooleanField(default=False, verbose_name='Черновик')),
                ('actors', models.ManyToManyField(related_name='film_actor', to='movies.actor', verbose_name='аткеры')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movies.actor', verbose_name='актеры')),
